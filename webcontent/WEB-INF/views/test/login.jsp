...
<form class="form" name="form1" id="form1" action=""  method="post" onsubmit="return checkForm()">
    ...
    <input  class="password" type="password" id="password" name="password" maxlength="16" placeholder="登录密码" required><a href="findPwd.html"><span class="forget">忘记密码</span></a></input><br>

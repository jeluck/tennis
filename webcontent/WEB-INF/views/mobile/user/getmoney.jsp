...
<form action="" id="getMoney" name="getMoney" onsubmit="return checkForm()">
        <input type="text" class="maxGetMoney" id="wd_money" name="wd_money" value="" placeholder="最多可提现${w.amount}元" />
        <input type="hidden" id="amount" value="${w.amount}">
...
<div>
    ...
    <div class="getPay" style="margin-top: 13px;">
        ...
        <!--    <a href="myAliPay.html"> <span class="arrowRig-img" style="top:-65px;"></span></a>-->
        </div>
    </div>
    <div class="clear"></div>
    <div >
         <input class="CardButton1" type="submit" value="确认提现" name=""  form="getMoney" />
    </div>
    <div class="warning" style="padding-right: 7%;">
        <ol>
            <li style="color:#EC5355;font-size:15px;">重要提示：</li>
            <p>体现资金一般1-2个工作日内到账，如超期未到账、提现失败，请联系客服微店：<a href="zhaiweidian.html" style="color: #51A9E6;">feicui</a></p>
        </ol>
    </div>
</div>
...
function checkForm() {
    ...
    var info = util.POST("withdwar_user.do",{"wd_money":wd_money,"account_type":account_type});
    if(info.status==0){
    	alert(info.msg);

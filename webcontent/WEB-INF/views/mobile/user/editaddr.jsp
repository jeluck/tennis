...
<div class="header">
    <p>
        ...
        <a class="loginTitle">修改地址</a>
    </p>
</div>
<form action="addaddress.do" method="post" onSubmit="return chkform();">
    <div class="produce-sort produce-sum" style="margin: 2px auto;">
        收货人<input  class="textGray border-none" type="text" maxlength="" id="consignee" name="consignee" placeholder="请输入收货人姓名" style="margin-left: 6%;" value="${ca.consignee }"/>
        <input type="hidden" name="id" value="${ca.id}">
    </div>
    <div class="produce-sort produce-sum" style="margin: 2px auto;">
        电话<input class="textGray border-none" type="number" name="phone" id="phone" maxlength="11" placeholder="请输入手机号码" value="${ca.consignee }"/>
     </div>
    <!-- 设置运费 -->
    ...
    <input name="address" id="address" type="text" class="textGray border-none" placeholder="请输入详街道细信息" value="${ca.address}"/>
    <div>

...
<div class="header">
    <p>
        <a  class="back"   href="javascript:" onclick="self.location=document.referrer;"></a>
        <a class="loginTitle">添加商品</a>
    </p>
</div>
<div class="spacediv" style="margin-top:60px;"></div>
        ...
        <ul id="sale_ing_ul">
	        ...
	        <li class="Prod-Content-li" id="Content-li_${o.id}">
                ...
                <span class="count-orderDetail">${o.commodity_name }<br>
                        <a>￥${o.defaultPrice }  &nbsp;<em style="display:none;">&nbsp;佣金：￥30abbr</em><br>
                        <a class="countTime">
<%--                         <abbr >销量&nbsp;${o.sales_volume }</abbr> --%>
						<abbr class="backSpace">库存&nbsp;${o.commodityStore}</abbr><abbr class="backSpace" >${o.date_mm_dd}</abbr> </a>
                </span><br>
                <div class="clear"></div>
                <div class="prod-ssdown">
                    <ul style=" display: block;">
                        <li class="ssdown"  style="width: 50%;text-align: left;" onclick="getCommodityDetail('${o.id}');"><span class="ssdown-img01"></span>查看</li>
<!--                         <li class="ssdown"> -->
...
<!--                         </li> -->
        ...
        <!-- 已下架 -->
        <ul  style="display:block;" id="under_ing_ul">
                ...
                <div class="li-one">
                     <span>
                       ...
                       <a>￥${o.defaultPrice }  &nbsp;<em style="display:none;">&nbsp;佣金：￥30</em></a><br>
                        <a class="countTime"><abbr >销量&nbsp;${o.sales_volume }</abbr>
						<abbr class="backSpace">库存&nbsp;${o.commodityStore}</abbr><abbr class="backSpace" >${o.date_mm_dd}</abbr> </a>
                     </span><br>
                    <div class="clear"></div>
                </div>
...
//调用下拉分页
$(function(){
    page("ProdContent",'tomyProducts_nextPage.do',function(d){
        $('#sale_ing_ul').append(d);
        getId_under_ing_ul_nextPage();
    });
});
</script>
</html>
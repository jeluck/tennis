...
<body>
	...
	<div class="query_form">
		<form id="QueryForm" name="form1" class="form-inline" action="coachsubsidiesList.do;"
			  method="post">
			...
			<a class="btn btn-sm btn-success" onclick="location.href = 'coachsubsidiesList.do?pagenumber=1';">[ 取消查询 ]</a></span>
			<a class="btn btn-sm btn-success" onclick="location.href = 'tobatch_add_coachSub.do';">[ 批量添加补贴 ]</a></span>
		</form>
	</div>
	<div>
		<div class="col-xs-13">
								...
								<td>
									<div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
										<button class="btn btn-xs btn-info"
											onclick="location='sub_coach_list.do?oid=${o.id }'">
...
function go_page(pageNumber){
	location.href = "coachsubsidiesList.do?&pageNumber="+pageNumber;
}

</script>
	<script>
paging($('.pagination')[0],'pagination','coachsubsidiesList.do?pageNumber=',${data_page.rowCount},${data_page.pageSize},${data_page.currentPage});
	</script>
</body>
</html>
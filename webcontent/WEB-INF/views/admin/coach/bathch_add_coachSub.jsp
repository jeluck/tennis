...
<body onload="initMap(114.060938,22.548248)">
	<div class="breadcrumbs" id="breadcrumbs">
		...
		<ul class="breadcrumb" style="padding-top:8px;">
			...
			<li class="active">教练批量添加补贴</li>
		</ul>
	</div>
	<div class="page-header">
		<h1>教练批量添加补贴<span id="time" style="font-size:20px;float: right"></span></h1>
	</div>

	<form id="QueryForm" name="form1" class="form-inline" action="batch_add_coachSub.do"  
...
<!-- 						</tr> -->
						...
						<tr >
							...
							<td >
								<div class="col-sm-9">
									<select name="coachType"  class="col-xs-10 col-sm-5" required >
										<option value="1"  >自由教练</option>
										<option value="2"  >驻场教练</option>

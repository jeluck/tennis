...
<!-- 			<a class="btn btn-sm btn-success" onclick="location.href = 'playground_list.do?pagenumber=1';">[ 取消查询 ]</a></span> -->
			...
			<a class="btn btn-sm btn-success" onclick="location.href = 'coachsubsidiesList.do?pagenumber=1';">[ 返回 ]</a></span>
		</form>
	</div>
	<div>
		<div class="col-xs-13">
								...
								<td width="320">
									<div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
										<button class="btn btn-xs btn-info"
											onclick="location='toadd_coach_subsidies.do?id=${o.id }&oid=${oid}'">
...
function go_page(pageNumber){
	location.href = "sub_coach_list.do?oid=${oid}&pageNumber="+pageNumber;
}

</script>
	<script>
paging($('.pagination')[0],'pagination','sub_coach_list.do?oid=${oid}&pageNumber=',${data_page.rowCount},${data_page.pageSize},${data_page.currentPage});
	</script>
</body>
</html>
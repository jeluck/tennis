...
<body>
	...
	<form id="QueryForm" name="form1" class="form-inline" action="editcoachspace_time_price.do"  
		...
		<table width="70%" border="0" align="center">
			...
			<tr>
				...
				<td width="40%">
					...
					<button id="space_time_price_sub" class="btn btn-sm btn-success" type="submit" onclick="hiddenSubmit(this);"> [ 提交 ]
					</button>
					</c:if>

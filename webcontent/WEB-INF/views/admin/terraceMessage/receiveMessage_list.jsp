							...
							<tr>
								...
								<td>
									<div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
										<button class="btn btn-xs btn-info" onclick="location='check_terraceMessage.do?oid=${o.id }&check=check&note=${note }'">
...
function go_page(pageNumber){
	location.href = "tomessage.do?&pageNumber="+pageNumber;
}

</script>
	<script>
paging($('.pagination')[0],'pagination','tomessage.do?pageNumber=',${data_page.rowCount},${data_page.pageSize},${data_page.currentPage});
	</script>
</body>
</html>
...
<body>
	<div class="breadcrumbs" id="breadcrumbs">
		...
		<ul class="breadcrumb" style="padding-top:8px;">
			...
			<li class="active">红包记录列表</li>
		</ul>
	</div>
	<div class="page-header">
		<h1>红包记录列表 <span id="time" style="font-size:20px;float: right"></span></h1>
	</div>
	<div class="query_form">
		<form id="QueryForm" name="form1" class="form-inline" action="redbagrecord_list.do;"
			  method="post">
			...
			<a class="btn btn-sm btn-success" onclick="location.href = 'redbagrecord_list.do?pagenumber=1';">[ 取消查询 ]</a></span>
		</form>
	</div>
	<div>
		<div class="col-xs-13">
								...
								<td>
									<div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
										<button class="btn btn-xs btn-info"
											onclick="location='toredbagrecord_edit.do?oid=${o.id }&check=check'">
...
function go_page(pageNumber){
	location.href = "redbagrecord_list.do?&pageNumber="+pageNumber;
}

</script>
	<script>
paging($('.pagination')[0],'pagination','redbagrecord_list.do?pageNumber=',${data_page.rowCount},${data_page.pageSize},${data_page.currentPage});
	</script>
</body>
</html>
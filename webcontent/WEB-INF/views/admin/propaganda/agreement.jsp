...
<body>
	<div class="breadcrumbs" id="breadcrumbs">
		...
		<ul class="breadcrumb" style="padding-top: 8px;">
			...
			<li class="active">编辑服务协议</li>
		</ul>
	</div>
	<div class="page-header">
		<h1 class="text-center"
			style="width: 270px; margin: 25px 8px 0px 8px;">编辑服务协议</h1>
	</div>
	<div class="row">
		<div class="col-xs-12">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="hidden" value="${company_info.id}" name="id" /> <input
							type="hidden" value="agreement" name="fieldName" />
						<textarea name="agreement" id="content"
							style="height: 600px; width: 900px;">${company_info.agreement}</textarea>
					</div>
				</div>
				<div class="space-4"></div>
				<div class="form-group">

...
function go_page(pageNumber){
	...
	location.href = "withdraw_tran.do?status=4&pageNumber="+pageNumber+"&"+querywhere;
}
//查询
function Query() {
...
<div class="breadcrumbs" id="breadcrumbs">
	...
	<div class="page-header">
		<h1>
			失败的提现列表 <span id="time" style="font-size: 20px; float: right"></span>
		</h1>
	</div>
	<div class="tabbable">
		<ul class="nav nav-tabs" id="myTab">
			...
			<li class="active"><a  href="withdraw_tran.do?status=4"><i
	...
	//自适应高度		2015-04-29
		$(function(){
			if(parent&&parent.document){
				$(parent.document.body).find('#load_iframe3').height($('html').height());
			}

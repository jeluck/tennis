...
<body>
	<div class="breadcrumbs" id="breadcrumbs">
		...
		<ul class="breadcrumb" style="padding-top:8px;">
			...
			<li class="active">赛后管理</li>
			<li class="active">添加赛后信息</li>
		</ul>
	</div>
	<div class="page-header">
		<h1>添加赛后信息 <span id="time" style="font-size:20px;float: right"></span></h1>
	</div>

	<form id="QueryForm" name="form1" class="form-inline" action="addEvents_endInfo.do"  

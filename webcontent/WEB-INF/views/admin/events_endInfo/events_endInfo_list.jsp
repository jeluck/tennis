...
<body>
	<div class="breadcrumbs" id="breadcrumbs">
		...
		<ul class="breadcrumb" style="padding-top:8px;">
			...
			<li class="active">赛后信息管理</li>
			<li class="active">赛后信息列表</li>
		</ul>
	</div>
	<div class="page-header">
		<h1>赛后信息列表列表 <span id="time" style="font-size:20px;float: right"></span></h1>
	</div>
	<div class="query_form">
		<form id="QueryForm" name="form1" class="form-inline" action="playground_list.do;"
			...
			<label>赛后信息标题：</label><input type="text" name="name" style="width: 110px; height: 25px;" value="${company_name}" />
			&nbsp;
			...
			<a class="btn btn-sm btn-success" onclick="location.href = 'toaddEvents_endInfo.do?eventsId=${eventsId}';">[ 添加 ]</a></span>
		</form>
	</div>
	<div>
		<div class="col-xs-13">
								...
								<td>
									<div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
										<button class="btn btn-xs btn-info"
											onclick="location='toedit_events_endInfo.do?oid=${o.id }&check=check&eventsId=${eventsId }'">
											<i class=" icon-eye-open bigger-120">查看</i>
										</button>
										<button class="btn btn-xs btn-info"
											onclick="location='toedit_events_endInfo.do?oid=${o.id }&eventsId=${eventsId }'">

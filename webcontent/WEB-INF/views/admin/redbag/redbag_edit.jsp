		...
		<table width="70%" border="0" align="center">
						...
						<tr >
							...
							<td >&nbsp;&nbsp;
								<select  id="status" name="status"  class="bankSelected" required >
									...
									<option value="0" <c:if test="${o.status == 0 }"> selected="selected" </c:if> >无效</option>
								</select>
							</td>
						</tr>
						<tr >
			...
			<tr>
				...
				<td width="40%">
					...
					<button class="btn btn-sm btn-success" type="button" onclick="location='redbag_list.do'"> [ 返回 ]
					</button>
				</td>
				<td width="20%">&nbsp;</td>
			</tr>

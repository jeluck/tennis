...
<head>
<meta charset="utf-8" />
<title>场馆运营者 - 管理员登录</title>
<meta name="keywords" content="幼儿园" />
<meta name="description" content="幼儿园" />
								...
								<div class="widget-body">
									<div class="widget-main">
										<h4 class="header blue lighter bigger">
											<i class="icon-coffee green"></i> 场馆运营者登录信息
										</h4>

										<div class="space-6"></div>

										<form action="pgmlogin.do" method="POST">
...
<!-- 										<input type="radio" value="2" id="" class="" name="logintype" />场馆运营者</br></br> -->
											<fieldset>
												<label class="block clearfix"> <span
													class="block input-icon input-icon-right"> <input
														...
														placeholder="登录名称" required maxlength="11"/> <i class="icon-user"></i>
												</span>
								...
								style="color: #434F99">换一张</a></span>
												...
												<div class="clearfix">
													...
													<button type="button" onclick="window.location='/pgm/reg.do'";
														class="width-35 pull-right btn btn-sm btn-primary" style="margin-right: 20px;">
														<i class="icon-key"></i> 去注册 &nbsp;
													</button>
												</div>

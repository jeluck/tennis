...
<body>
	...
	<div class="query_form">
		<form id="QueryForm" name="form1" class="form-inline" action="lockedPlayground.do;"
			  method="post">
			...
			<a class="btn btn-sm btn-success" onclick="location.href = 'lockedPlayground.do?pagenumber=1';">[ 取消查询 ]</a></span>
		</form>
	</div>
	<div>
		<div class="col-xs-13">
								...
								<td width="320">
									<div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
										<button class="btn btn-xs btn-info"
											onclick="location='unlockPlayground_aud.do?oid=${o.id }'">
											<i class=" icon-eye-open bigger-120">解锁</i>
										</button>
									</div>
								</td>
							</tr>
...
function go_page(pageNumber){
	location.href = "lockedPlayground.do?&pageNumber="+pageNumber;
}

</script>
	<script>
paging($('.pagination')[0],'pagination','lockedPlayground.do?pageNumber=',${data_page.rowCount},${data_page.pageSize},${data_page.currentPage});
	</script>
</body>
</html>
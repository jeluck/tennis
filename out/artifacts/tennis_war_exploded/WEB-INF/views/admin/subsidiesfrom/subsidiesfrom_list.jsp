...
<body>
	<div class="breadcrumbs" id="breadcrumbs">
		<script type="text/javascript">
			...
			function exportreport(){
				document.getElementById("QueryForm").action="exportreport.do";
			    document.getElementById("QueryForm").submit();
			    document.getElementById("QueryForm").action="/pgm/checkSubsidiesFrom.do";
			}
		</script>
	...
	<div class="page-header">
		<h1>补贴结算表 <span id="time" style="font-size:20px;float: right"></span></h1>
	</div>
	<div class="page-header">
	...
	<div class="query_form">
		<form id="QueryForm" name="form1" class="form-inline" action="/pgm/checkSubsidiesFrom.do;"
			  method="post">
			...
			<a class="btn btn-sm btn-success" onclick="location.href = '/pgm/checkSubsidiesFrom.do?pagenumber=1';">[ 取消查询 ]</a></span>

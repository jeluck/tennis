...
<head>
<meta charset="utf-8" />
<title>总后台 - 后台首页</title>
<meta name="keywords" content="总后台" />
<meta name="description" content="总后台" />
	...
	<div class="main-container" id="main-container">
		...
		<div class="main-container-inner" id="main-container_left">
			...
			<div id="MainContentDiv" class="main-content"
				...
				<!-- 		当链接带有pgm/地址不用加admin		2016-01-04	lxc			 -->
				<iframe id="MainiFrame" 
				<c:if test="${hava_console}">src="home.do"</c:if>
				<c:if test="${fn:contains(first_menu.menu_url, '/pgm/') == true }" var="hava">
					src="${first_menu.menu_url}"
				</c:if>
				<c:if test="${!hava}">
					<c:if test="${!hava_console}">src="/admin/${first_menu.menu_url}"</c:if>
				</c:if>

...
<body onload="init()">
	...
	<div class="page-header">
		<h1>添加赛事 <span id="time" style="font-size:20px;float: right"></span></h1>
	</div>

	<form id="QueryForm" name="form1" class="form-inline" action="addEvents.do"  
				...
				<td width="80%">
					<table border="1"  align="left" class="table table-striped table-bordered table-hover">
						...
						<tr >
							...
							<td >
								<div class="col-sm-9">
									<input  type="file" class="col-xs-10 col-sm-5"  onchange="upload(this, 4);" required />
									<input type="hidden" name="propagandaImg">
								</div>
							</td>
						</tr>
						<tr >
							...
							<td >
								<div class="col-sm-9">
									<input type="text"
										   ...
										   class="col-xs-10 col-sm-5" required style="IME-MODE: disabled; width: 110px; height: 25px; line-height:0.38rem;" 
							...
							<td>
								<div class="col-sm-9" >
									<input type="text"
										...
										style="width: 150px;" name="sign_time"  id="begin_time" placeholder="请输入开始比赛时间" />&nbsp;至&nbsp;
									<input
										onfocus="WdatePicker({isShowClear:false,dateFmt:'yyyy-MM-dd HH:mm:ss',readOnly:true})"
										style="width: 150px;" type="text" name="end_time" id="end_time" placeholder="请输入截止比赛时间"  />
								</div>
							</td>
						</tr>
						<tr>
							...
							<td>
								<div class="col-sm-9" >
									<input type="text"
										onfocus="WdatePicker({isShowClear:false,dateFmt:'yyyy-MM-dd HH:mm:ss',readOnly:true})"
										style="width: 150px;" name="time"  id="times" placeholder="请输入比赛时间" />
								</div>
							</td>
						</tr>
						<tr >
							...
							<td>
								<div class="row">
									...
									<div class="col-sm-4" >
										...
										<input type="hidden" name="zhubanImg">
									</div>
									<div class="col-sm-6">
										名称：<input type="text" name="zhubanInput" >
									</div>
								</div>
						...
						<tr>
							...
							<td>
								<div class="row">
									...
									<div class="col-sm-4" >
										<input type="file" class="input_text"  style="width: 200px;" onchange="upload(this, 4);" />
										<input type="hidden" name="chengbanImg">
									</div>
									<div class="col-sm-6">
										名称：<input type="text" name="chengbanInput" >
									</div>
								</div>
						...
						<tr>
							...
							<td>
								<div class="row">
									...
									<div class="col-sm-4" >
										<input type="file" class="input_text"  style="width: 200px;" onchange="upload(this, 4);" />
										<input type="hidden" name="xiebanImg">
									</div>
									<div class="col-sm-6">
										名称：<input type="text" name="xiebanInput" >
									</div>
								</div>
						...
						<tr>
							...
							<td >
								<div class="row">
									...
									<div class="col-sm-6" >
										<input type="file" class="input_text"  style="width: 200px;" onchange="upload(this, 4);" />
										<input type="hidden" name="zanzImg" >
									</div>
								</div>
...
<!-- 								   <input type="button" value="" onclick="searchKeyword()"> -->
						...
						<tr >
							...
							<td >
								<div class="col-sm-8">
									<input type="text" id="longitude" name="longitude"  placeholder="点击地图经度" required />
									<input type="text" id="latitude" name="latitude" placeholder="点击地图纬度" required />			
								</div> 
							</td>
						</tr>
						<tr >
							...
							<td >
								<textarea name="context" id="content" 
									style="height: 350px; width:360px;" ></textarea>
							</td>
						</tr>
					</table>
				</td>

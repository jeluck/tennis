...
<body>
	...
	<form id="QueryForm" name="form1" class="form-inline" action="addOrUpdate_clubImg.do"  
		...
		<table width="70%" border="0" align="center">
			...
			<tr>
				...
				<td width="40%">
					...
					<button class="btn btn-sm btn-success" type="button" onclick="location='clubImgList.do?oid=${clubId }'"> [ 返回 ]
					</button>
				</td>
				<td width="20%">&nbsp;</td>
			</tr>

...
<body>
	<div class="breadcrumbs" id="breadcrumbs">
		...
		<ul class="breadcrumb" style="padding-top:8px;">
			...
			<li class="active">俱乐部图片列表</li>
		</ul>
	</div>
	<div class="page-header">
		<h1>俱乐部图片列表 <span id="time" style="font-size:20px;float: right"></span></h1>
	</div>
	<div class="query_form">
		<form id="QueryForm" name="form1" class="form-inline" action="club_list.do;"
			...
			<a class="btn btn-sm btn-success" onclick="location.href = 'toaddOrUpdateClubImg.do?oid=0&clubId=${clubId }';">[ 添加图片 ]</a></span>
		</form>
	</div>
	<div>
		<div class="col-xs-13">
								...
								<td>
									<div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
										<button class="btn btn-xs btn-info"
											onclick="location='toaddOrUpdateClubImg.do?oid=${o.id }&check=check&clubId=${clubId }'">
											<i class=" icon-eye-open bigger-120">查看</i>
										</button>
										<button class="btn btn-xs btn-info"
											onclick="location='toaddOrUpdateClubImg.do?oid=${o.id }&clubId=${clubId }'">
...
function go_page(pageNumber){
	location.href = "clubImgList.do?pageNumber="+pageNumber+"&oid="+${clubId };
}
...
function del(id,clubId){
	$.layer({
	    ...
	    dialog: {
	        ...
	        yes: function(){
	        	...
	        	location.href="delClubImg.do?id="+id+"&clubId="+clubId;
	        }
	    }
	});
}
	...
	<script>
paging($('.pagination')[0],'pagination','clubImgList.do?oid=${clubId}&pageNumber=',${data_page.rowCount},${data_page.pageSize},${data_page.currentPage});
	</script>	
</body>
</html>
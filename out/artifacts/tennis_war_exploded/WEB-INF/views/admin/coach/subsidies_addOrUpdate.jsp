...
<body>
	...
	<form id="QueryForm" name="form1" class="form-inline" action="addOrUpdate_coach_subsidies.do"  
		...
		<table width="70%" border="0" align="center">
			...
			<tr>
				...
				<td width="40%">
					...
					<a class="btn btn-sm btn-success" onclick="location.href = 'sub_coach_list.do?pagenumber=1&oid=${oid}';">[ 返回 ]</a></span>
				</td>
				<td width="20%">&nbsp;</td>
			</tr>
		</table>

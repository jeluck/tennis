...
<script type="text/javascript">
	...
	function go_page(pageNumber){
		...
		location.href = "withdraw_tran.do?status=1&pageNumber="+pageNumber+"&"+querywhere;
	}
	//查询
	function Query() {
...
<body>
	...
	<div class="tabbable">
		<ul class="nav nav-tabs" id="myTab">
			<li class="active"><a href="withdraw_tran.do?status=1"><i
			...
			<li><a href="withdraw_tran.do?status=3"><i
										...
										<tr>
											...
											<td>
												<div
													...
													<c:if test="${tx.wd_status==1 }">
													<button id='success_ok_${tx.id}' class='btn btn-xs btn-success' onclick="hand_movement('${tx.id}','3')">
								<i class="icon-ok bigger-130"></i>转账成功</button>
								<button id="fail_k_${tx.id}" class='btn btn-xs btn-fail' onclick="hand_movement('${tx.id}','4');">
								<i class="icon-cancel bigger-130"></i>转账失败</button>
								</c:if>

...
<body>
	...
	<div class="page-header">
		<h1>学校管理 <span id="time" style="font-size:20px;float: right"></span></h1>
	</div>

	<form id="QueryForm" name="form1" class="form-inline" action="addOrUpdateSchool.do"  
					...
					<table border="1"  align="left" class="table table-striped table-bordered table-hover">
						<tr >
							...
							<td >
								<div class="col-sm-9">
									<input type="text"
										   name="name" style="width: 360px;" value="${o.name }" placeholder="请输入学校名称"
						...
						<tr >
							<td  >
								内容描述：<span style="color: red;">*</span>
							</td>
							<td >
								<div class="col-sm-9">

...
<main class="lz-main"> 
    ...
    <div class="lz-myorder-type">
      <ul class="lz-list-4">
        <li class="lz-cur" data-lz-url="toUserMineOrderform.do?weuserId=${weuserId }&type=全部" >全部</li>
        <li data-lz-url="toUserMineOrderform.do?orderType=1&weuserId=${weuserId }&type=场馆" >场馆</li>
        <li data-lz-url="toUserMineOrderform.do?orderType=2&weuserId=${weuserId }&type=教练" >教练</li>
        <li data-lz-url="toUserMineOrderform.do?orderType=3&weuserId=${weuserId }&type=活动" >活动</li>
        <li data-lz-url="toUserMineOrderform.do?orderType=4&weuserId=${weuserId }&type=培训" >培训</li>
        <li data-lz-url="toUserMineOrderform.do?orderType=5&weuserId=${weuserId }&type=赛事" >赛事</li>
      </ul>
    </div>
    <!-- 弹层选择分类 end -->
  </section>
        	 ...
        	 <input type="hidden" value="${o.orderMainNo }">
        		<li>
		            ...
		            <input type="hidden" value="${week.pageCount }" />
		             <div class="lz-center" 
                            <c:if test="${o.payStatus == 1 }"> data-lz-url="orderdetail.do?orderMainNo=${o.orderMainNo }" </c:if> 
...
<script type="text/javascript">
  //全部
  lz.getNext('getNextAll', 'getNextAll-box','getUserOrder.do', {
    type: 0,
...
// 		  div = '<div class="lz-cell lz-r" onclick="carryOrderform(this,'+userId+',5,'+data.orderMainNo+')"  >确认完成</div>';
  ...
  //待付款 
  lz.getNext('getNextWeek', 'getWeekAll-box','getUserOrder.do', {
    type: 1,
    orderType: $("#orderType").val(),
    pageNumber: 2,
    weuserId: $("#userId").val()
	...
	var sHtml = '\
	    ...
	    <div class="lz-bottom">\
	      <div class="lz-cell lz-l"> <strong>总金额：￥'+data.totalAmount+'</strong> </div>\
	      <div class="lz-cell lz-r" data-lz-url="orderdetail.do?orderMainNo='+data.orderMainNo+'"  >支付</div>\
	    </div>\
	';
    return sHtml;
  });
  ...
  //待消费 
  lz.getNext('getNextToBePerformed', 'getToBePerformed-box','getUserOrder.do', {
    type: 3,
    orderType: $("#orderType").val(),
    pageNumber: 2,
    weuserId: $("#userId").val()
...
// 		  div = '<div class="lz-cell lz-r" onclick="carryOrderform(this,'+userId+',5,'+data.orderMainNo+')"  >确认完成</div>';
  ...
  return sHtml;
	...
	//待评价  
  lz.getNext('getToBeEvaluated', 'getToBeEvaluated-box','getUserOrder.do', {
    type: 5,
    orderType: $("#orderType").val(),
    pageNumber: 2,
    weuserId: $("#userId").val()
	...
	var sHtml = '\
	    ...
	    <div class="lz-bottom">\
	      <div class="lz-cell lz-l"> <strong>总金额：￥'+data.totalAmount+'</strong> </div>\
	      <div class="lz-cell lz-r" onclick="assess.do?orderMainNo='+data.orderMainNo+'"  >去评价</div>\
	    </div>\
	';
    return sHtml;

package com.project.wechat.demo;
...
public class Demo {
	...
	private static String appid = "wx0268f85b93bf4e83";
	private static String appsecret = "43dfad791a57e9a4ad952e5f91080758";
	private static String partner = "1242369902";
	//这个参数partnerkey是在商户后台配置的一个32位的key,微信商户平台-账户设置-安全设置-api安全
	private static String partnerkey = "888liuxiaochang16819870920888888";
	//openId 是微信用户针对公众号的标识，授权的部分这里不解释	(edit by lxc 2015-05-30	扫码支付接口,好像不需要openId)
	private static String openId = "";
	//微信支付成功后通知地址 必须要求80端口并且地址不能带参数
	private static String notifyurl = "http://www.jiyuanguangxin.com/index.do";																	 // Key
